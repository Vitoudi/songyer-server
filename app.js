...
const { GameManager, GameHandler } = require("./classes/Game.js");
...
const io = require("socket.io")(http, {
  cors: {
    origins: ["http://localhost:3000", "https://songyer.vercel.app"],
    methods: ["GET", "POST"],
  },
});
...
io.of("/").on("connection", (socket) => {
  ...
  const roomHandler = new RoomHandler(handlerOptions, roomManager, gameManager);
  const gameHandler = new GameHandler(handlerOptions, roomManager, gameManager);
